...
%define THIRD_STAGE_OFFSET          0x10000
;********************************* Main Program **************************************
      call bios_cls
      mov si, greeting_msg    ; a message that we entered the second stage
      call bios_print         
      call get_key_stroke      
      call check_a20_gate     ; check if the a20 is available, and if it is enabled
      call check_long_mode    ;check if long mode is available
      call memory_scanner     ;scan the available memory regions
      call print_memory_regions;print the details of scanned memory regions
      ...
      hang:                   ;hangs the program, until any interrupt is received
            hlt               
            jmp hang          
;************************************* Data ******************************************
